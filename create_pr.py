...
payload = {"title": "Fix for issue #111", "body": "Closes #111\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-111", "base": "main"}
...
try:
    with urllib.request.urlopen(req, context=ctx) as r: 
        ...
        os.chdir("..")
        shutil.rmtree("/Users/kartavyadikshit/Projects/Open Source/mcp-task-app_bounty_parallel_13", ignore_errors=True)
